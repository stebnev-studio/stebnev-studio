<template>
  <Header class="header" :header="dataHeader.acf.header" :links="dataFooter.acf.footer.repeater" />
  ...
  <Footer class="footer" :footer="dataFooter.acf.footer" ></Footer>
</template>
